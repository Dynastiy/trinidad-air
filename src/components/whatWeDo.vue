<template>
  <div>
    <div class="text-center container-fluid what--we_do" id="about-us">
      <div class="jet--comfort py-5">
        <h2 style="font-weight: 600; color: var(--primary-color)">
          JET COMFORT
        </h2>
        <h1 style="font-weight: 800; color: var(--accent-color-dark)">
